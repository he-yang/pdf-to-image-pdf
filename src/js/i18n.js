...
const i18n = {
  zh: {
    ...
    freeVersion: '完全免费',
    contactUs: '📞 贡献与反馈',
    wechat: '欢迎在 GitHub 提交 issue 或 PR https://github.com/he-yang/pdf-to-image-pdf',
    close: '关闭',
    copied: '已复制',
    copy: '复制',
  ...
  en: {
    ...
    wechat: 'Welcome to submit issues or PRs on GitHub: https://github.com/he-yang/pdf-to-image-pdf',
    close: 'Close',
    copied: 'Copied',
    copy: 'Copy',
